...
import com.outfitterspk.jdbc.JuniorProductDBUtil;
...
@WebServlet("/JuniorsProductsServlet")
public class JuniorsProductsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	private JuniorProductDBUtil juniorProductDBUtil;
	...
	public void init() throws ServletException {
		...
		try {
			juniorProductDBUtil=new JuniorProductDBUtil(dataSource);
		}
		catch(Exception exc) {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void listProducts(HttpServletRequest request, HttpServletResponse response) 
		...
		List<Product> products= juniorProductDBUtil.getJuniorProducts();
		
		//add products to the request
		request.setAttribute("JUNIOR_PRODUCTS_ALL", products);
		
		//send to JSP page(view)
		RequestDispatcher dispatcher= request.getRequestDispatcher("view-junior.jsp");
    ...
    private void loadProduct(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		//get product from database (db util)
			Product theProduct = juniorProductDBUtil.getJuniorProduct(theProductId);
			
		//get product from database (db util)
			List<ProductVariant> theProductVariant = juniorProductDBUtil.getJuniorProductVariant(theProductId);
