...
import com.outfitterspk.jdbc.ProductCustomerDBUtil;
...
@WebServlet("/ProductCustomerServlet")
public class ProductCustomerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	private ProductCustomerDBUtil productDBUtil;
	...
	public void init() throws ServletException {
		...
		try {
			productDBUtil=new ProductCustomerDBUtil(dataSource);
		}
		catch(Exception exc) {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void loadProduct(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		//get product from database (db util)
			List<ProductVariant> theProductVariant = productDBUtil.getProductVariant(theProductId);
