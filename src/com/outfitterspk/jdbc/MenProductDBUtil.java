...
public class MenProductDBUtil {
	
	private DataSource dataSource;
	
	public MenProductDBUtil(DataSource theDataSource) {
		this.dataSource=theDataSource;
	}
	
	public List<Product> getMenProducts() throws Exception{
		...
		//close JDBC object
			System.out.println("Men Products: "+products);
			return products;
		}
		finally {
...
public Product getMenProduct(int theProductId) throws Exception {
		...
		try {
			...
			if(myRs.next()) {
				...
				throw new Exception("Could not find Men product id: " +theProductId);
			}
...
public List<ProductVariant> getMenProductVariant(int theProductId) throws Exception {
