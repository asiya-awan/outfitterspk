...
public class ProductCustomerDBUtil {
	
	private DataSource dataSource;
	
	public ProductCustomerDBUtil(DataSource theDataSource) {
...
public Product getProduct(int theProductId) throws Exception {
...
public List<ProductVariant> getProductVariant(int theProductId) throws Exception {
