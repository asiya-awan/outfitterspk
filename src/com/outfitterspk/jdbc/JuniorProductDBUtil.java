...
public class JuniorProductDBUtil {
	
	private DataSource dataSource;
	
	public JuniorProductDBUtil(DataSource theDataSource) {
		this.dataSource=theDataSource;
	}
	
	public List<Product> getJuniorProducts() throws Exception{
...
public Product getJuniorProduct(int theProductId) throws Exception {
...
public List<ProductVariant> getJuniorProductVariant(int theProductId) throws Exception {
