		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar02">
                ...
                HttpSession session10 = request.getSession(false);
               		 ...
               		 if(session10.getAttribute("email")!=null){
                
                %>

<li class="nav-item dropdown mr-2"><a href="#"
						class="nav-link dropdown-toggle text-capitalize" data-toggle="dropdown" ><%= session10.getAttribute("firstName") %>
							<%= session10.getAttribute("lastName") %></a>
						...
						<div class="row ">
							...
							<div id="w-products"
								...
								<div class="row my-4">
									...
									<c:forEach var="tempProduct" items="${MEN_PRODUCTS_ALL}">

										<!-- set up a link for each Product for edit -->
										<c:url var="tempLink" value="MenProductsServlet">
