		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar02">
				<ul class="navbar-nav text-uppercase">
					...
					<li class="nav-item"><a class="nav-link" href="JuniorProductsServlet">Juniors</a>
					</li>
...
<li class="nav-item dropdown mr-2"><a href="#"
						class="nav-link dropdown-toggle text-capitalize" data-toggle="dropdown" ><%= session11.getAttribute("firstName") %>
							<%= session11.getAttribute("lastName") %></a>
						...
						<div class="row ">
							...
							<div id="w-products"
								...
								<div class="row my-4">
									...
									<c:forEach var="tempProduct" items="${JUNIOR_PRODUCTS_ALL}">
