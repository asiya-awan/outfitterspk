		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar02">
                ...
                HttpSession session8 = request.getSession(false);
               		 ...
               		 if(session8.getAttribute("email")!=null){
                
                %>

<li class="nav-item dropdown mr-2"><a href="#"
						class="nav-link dropdown-toggle text-capitalize" data-toggle="dropdown" ><%= session8.getAttribute("firstName") %>
							<%= session8.getAttribute("lastName") %></a>
